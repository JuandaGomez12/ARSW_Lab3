...
public final class MedicalServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.EmptyRequest,
      edu.eci.arsw.wellness.medical.SpecialtyList> getGetSpecialtiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSpecialties",
      requestType = edu.eci.arsw.wellness.medical.EmptyRequest.class,
      responseType = edu.eci.arsw.wellness.medical.SpecialtyList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.EmptyRequest,
      edu.eci.arsw.wellness.medical.SpecialtyList> getGetSpecialtiesMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.EmptyRequest, edu.eci.arsw.wellness.medical.SpecialtyList> getGetSpecialtiesMethod;
      ...
      synchronized (MedicalServiceGrpc.class) {
        if ((getGetSpecialtiesMethod = MedicalServiceGrpc.getGetSpecialtiesMethod) == null) {
          MedicalServiceGrpc.getGetSpecialtiesMethod = getGetSpecialtiesMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.wellness.medical.EmptyRequest, edu.eci.arsw.wellness.medical.SpecialtyList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSpecialties"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.wellness.medical.EmptyRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.SpecialtyRequest,
      edu.eci.arsw.wellness.medical.Specialty> getGetSpecialtyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSpecialty",
      requestType = edu.eci.arsw.wellness.medical.SpecialtyRequest.class,
      responseType = edu.eci.arsw.wellness.medical.Specialty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.SpecialtyRequest,
      edu.eci.arsw.wellness.medical.Specialty> getGetSpecialtyMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.wellness.medical.SpecialtyRequest, edu.eci.arsw.wellness.medical.Specialty> getGetSpecialtyMethod;
      ...
      synchronized (MedicalServiceGrpc.class) {
        if ((getGetSpecialtyMethod = MedicalServiceGrpc.getGetSpecialtyMethod) == null) {
          MedicalServiceGrpc.getGetSpecialtyMethod = getGetSpecialtyMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.wellness.medical.SpecialtyRequest, edu.eci.arsw.wellness.medical.Specialty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getSpecialties(edu.eci.arsw.wellness.medical.EmptyRequest request,
    ...
    default void getSpecialty(edu.eci.arsw.wellness.medical.SpecialtyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.medical.Specialty> responseObserver) {
  ...
  public static final class MedicalServiceStub
    ...
    /**
     */
    public void getSpecialties(edu.eci.arsw.wellness.medical.EmptyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.medical.SpecialtyList> responseObserver) {
  ...
  public static final class MedicalServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.wellness.medical.SpecialtyList getSpecialties(edu.eci.arsw.wellness.medical.EmptyRequest request) {
    ...
    /**
     */
    public edu.eci.arsw.wellness.medical.Specialty getSpecialty(edu.eci.arsw.wellness.medical.SpecialtyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MedicalServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.wellness.medical.SpecialtyList> getSpecialties(
        edu.eci.arsw.wellness.medical.EmptyRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.wellness.medical.Specialty> getSpecialty(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SPECIALTIES:
          serviceImpl.getSpecialties((edu.eci.arsw.wellness.medical.EmptyRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.medical.SpecialtyList>) responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.wellness.medical.EmptyRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              edu.eci.arsw.wellness.medical.Specialty>(
